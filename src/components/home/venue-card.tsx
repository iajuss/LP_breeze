...
export function VenueCard({ venue, featured = false, regionInterest, activity, showPrice = false }: { venue: Venue; featured?: boolean; regionInterest?: InterestRegion; activity?: string; showPrice?: boolean }) {
